    ...
    onBeforeAction: function(pause){
        if(Meteor.user()!== undefined){
            if (Meteor.user()) {
                ...
                return [Meteor.subscribe('publication.followed.all'), Meteor.subscribe("publication.me.all"), Meteor.subscribe('user.all.username')];
            } else {
                this.render('home');
                //this.next();
            }
...
Router.route("/profile/:username",{
    ...
    waitOn: function(){
        return [Meteor.subscribe("user.profile.one", this.params.username), Meteor.subscribe("publication.one.all", this.params.username), Meteor.subscribe("publication.tagged.one.all", this.params.username)];
    }
});
